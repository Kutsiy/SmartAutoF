...
<template>
  <div
    class="border border-[var(--border-main)] rounded-2xl p-2 !bg-[var(--bg-main)] !p-4"
  >
    <template v-if="updatingCategory">
      <div class="flex flex-col gap-4 py-2">
        <div class="text-4xl text-[var(--text-important)]">Ви оновлюєте</div>
        <div
          class="basic-back p-4 text-3xl rounded-2xl flex items-center justify-between"
        >
