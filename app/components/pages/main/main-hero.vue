...
import UiCarCanvas from "~/components/ui/car-canvas.vue";
</script>

<template>
  <div class="relative w-full">
    <div class="absolute inset-0 top-[-130px] hero-back">
      <NuxtImg
        src="/background.png"
        class="w-full h-full object-cover select-none blur-[5px] grayscale-[20%] rotate-180 bg-no-repeat"
        draggable="false"
      />
    </div>
    <div class="w-full relative flex justify-center hero">
      <div class="w-full container mx-auto px-12 z-10 top-0 left-0">
        <div class="w-full flex justify-between py-6">
          <div
            class="w-[calc((100%/2)-50px)] flex flex-col justify-center"
